  ...
  return (
    <section className="branches-section relative py-24 overflow-hidden border-t border-[#E8AF34]/15">
      <picture className="absolute inset-0 w-full h-full pointer-events-none select-none">
        <source media="(min-width: 1024px)" srcSet="/Branches.png" />
        <source
          media="(min-width: 768px) and (max-width: 1023px) and (orientation: portrait)"
          srcSet="/Branches%20Tab%20Potrait.png"
        />
        <source media="(min-width: 640px)" srcSet="/Braches%20Tab.png" />
        <img
          src="/Branches%20Mobile.png"
          alt=""
          aria-hidden
  ...
  return (
    <article className="branch-card group flex h-full w-full min-w-0 flex-col self-stretch">
      ...
      <div className="branch-card-map-wrap shrink-0 px-2.5 pb-2.5 sm:px-3.5 sm:pb-3.5">
        <div className="branch-card-map relative overflow-hidden">
          <iframe
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="absolute bottom-2 right-2 inline-flex items-center gap-1 rounded-full bg-white/95 px-2.5 py-1 text-[10px] font-bold text-[#9A6B1A] shadow-md backdrop-blur-sm transition-colors hover:bg-white sm:text-[11px]"
          >
