...
export function TeacherSettingsPanel({
  ...
  async function handleForgotPasswordReset() {
    ...
    try {
      const res = await api.forgotPassword(email, "teacher");
  ...
  function handleLogout() {
    clearSession();
    navigate(PORTAL_AUTH.teacher.loginPath);
  }
  ...
  return (
    <AdminPageShell className="h-full flex flex-col min-h-0 overflow-hidden">
      <AdminPageBody className="flex-1 min-h-0 overflow-y-auto !mt-0 !pt-0">
        {profileLoading ? (
          <PortalSettingsLoading spinnerClassName="text-blue-600" />
        ) : (
          <PortalSettingsLayout>
            <PortalSettingsPageHeader
            ...
            <div className={portalSettingsGridClass}>
              <PortalSettingsCard
                ...
                iconWrapClassName="bg-blue-50 border border-blue-100"
                title="Profile Settings"
                subtitle="Your teacher portal account details"
                ...
                <div className="flex flex-col flex-1 min-h-0 h-full">
                  <div className="space-y-4 flex-1">
                    {[
                      ...
                      { label: "Phone", icon: Phone, value: display?.phone?.trim() || "Not provided" },
                      {
                        ...
                        icon: GraduationCap,
                        value: assignedClasses.length > 0 ? assignedClasses.join(", ") : "None",
                      },
                    ].map((field) => (
                      <div key={field.label}>
                  ...
                  <div className="flex items-start gap-3 pt-4 mt-auto shrink-0 border-t border-slate-100">
                    ...
                    <p className="text-[10px] font-semibold text-slate-500">
                      Role: <span className="text-slate-800 font-bold">Teacher</span>
                      {memberSince ? (
                        <>
                          {" "}
                  ...
                  <div className="space-y-4 flex-1">
                    <div>
                      ...
                      <PasswordInput
                        ...
                        className={`${portalSettingsPasswordClass} focus:border-blue-500 focus:bg-white`}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-right">
                        <button
                          ...
                          className="text-[10px] font-black text-slate-400 hover:text-blue-600 uppercase tracking-wider"
                        >
              ...
              <PortalSettingsSessionBar
                description="Logout of the Teacher Portal securely."
