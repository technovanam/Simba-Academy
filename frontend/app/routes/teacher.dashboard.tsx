...
export function meta({}: Route.MetaArgs) {
  return [{ title: "Teacher Dashboard | Simba Preschool" }];
}
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 shrink-0">
                    <div className="min-w-0">
                      <h2 className="text-sm lg:text-base font-bold text-slate-900 tracking-wide uppercase truncate">
                        Simba Preschool Teacher Portal
                      </h2>
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                          ...
                                          {t.status === "REJECTED" && t.rejectionReason && (
                                            <div className="flex items-start gap-1 bg-rose-50 border border-rose-100 rounded-lg px-2 py-1.5 max-w-[200px]">
                                              ...
                                              <p className="text-[9px] font-semibold text-rose-700 leading-snug truncate block">{t.rejectionReason}</p>
                                            </div>
                                          )}
                                        </div>
                                      </td>
                            ...
                            {[ 
                              ...
                              return (
                                <div key={t.id} className="p-4 flex flex-col gap-3 hover:bg-slate-50/80 transition-colors">
                                  ...
                                  {t.status === "REJECTED" && t.rejectionReason && (
                                    <div className="flex items-start gap-1.5 bg-rose-50 border border-rose-100 rounded-lg px-2.5 py-1.5 w-full">
                                      <AlertCircle className="w-3.5 h-3.5 text-rose-500 shrink-0 mt-0.5" />
                                      <p className="text-[10px] font-semibold text-rose-700 leading-snug truncate block">{t.rejectionReason}</p>
                                    </div>
                                  )}
